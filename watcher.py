...
os.environ['MAIL'] = 'yourmail@gmail.com'
os.environ['MAIL_PASS'] = 'yourmail'

def email_alert(message, status):
    fromaddr  = os.environ['MAIL']
    toaddrs = ['yourmail@gmail.com']

    server = SMTP('smtp.gmail.com:587')
    server.starttls()
    server.login(os.environ['MAIL'], os.environ['MAIL_PASS'])
...
def get_response(url):
    ...
    try:
        ...
        email_alert('Bad URL: %s' % url, 'Error Bad URL: %s ' % url)
        exit(1)
